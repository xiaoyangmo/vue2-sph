<template>
  <div class="order-right">
    <div class="order-content">
          ...
          <tr v-for="(detail,index) in order.orderDetailList" :key="detail.id">
            <td width="60%">
              <div class="typographic">
                ...
                <router-link :to="`/detail/${detail.skuId}`" class="block-text">{{ detail.skuName }}</router-link>
      ...
      <Pagination :pageNo="page" :pageSize="limit" :totalPages="orderList.pages" :continues="5" @getPage="getPage"></Pagination>
    </div>
    <!--猜你喜欢-->
    <div class="like">
      <h4 class="kt">猜你喜欢</h4>
...
export default {
  ...
  methods:{
    async getData() {
      let {page,limit}=this;
      let result= await this.$API.myOrder(page,limit);
      if (result.code===200){
